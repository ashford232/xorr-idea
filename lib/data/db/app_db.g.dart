...
abstract class _$AppDb extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [workspaces];
}
...
class $$WorkspacesTableFilterComposer
    extends Composer<_$AppDb, $WorkspacesTable> {
...
class $$WorkspacesTableTableManager
    extends
        RootTableManager<
          ...
          (Workspace, BaseReferences<_$AppDb, $WorkspacesTable, Workspace>),
          Workspace,
          PrefetchHooks Function()
        > {
  $$WorkspacesTableTableManager(_$AppDb db, $WorkspacesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  ...
                  BaseReferences<_$AppDb, $WorkspacesTable, Workspace>(
                    db,
                    table,
                    e,
                  ),
